...
function plusSlides(e){showSlides(slideIndex+=e)}function currentSlide(e){showSlides(slideIndex=e)}function showSlides(e){var s,n=document.getElementsByClassName("mySlides");for(e>n.length&&(slideIndex=1),e<1&&(slideIndex=n.length),s=0;s<n.length;s++)n[s].style.display="none";n[slideIndex-1].style.display="block"}var slideIndex=1;showSlides(slideIndex),$(document).ready(function(){var e=$(".menuToggle"),s=$(".search .close"),n=$(".search .btn__search");e.click(function(){e.toggleClass("menuToggle_active"),$(".menu").slideToggle(300,function(){"none"===$(this).css("display")&&$(this).removeAttr("style")})}),n.click(function(){s.removeClass("hidden"),$("input").addClass("focus")}),s.click(function(){s.addClass("hidden"),$("input").removeClass("focus")});var t=$(".projects__cart");$(".toggle");t.hover(function(){$(this).addClass("hover__cart"),$(".hover__cart p").removeClass("hidden"),$(".hover__cart .btn").addClass("btn__hover"),$(".hover__cart h3").css("margin-top","80px"),$(this).append($("<div class='filter'></div>"))},function(){$(this).find("div:last").remove(),$(".hover__cart h3").css("margin-top","115px"),$(".hover__cart .btn").removeClass("btn__hover"),$(".hover__cart p").addClass("hidden"),$(this).removeClass("hover__cart")})});